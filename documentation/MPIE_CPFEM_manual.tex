...
Model definition for using the subroutine: In MARC, state variable 1 defines the temperature in Kelvin. State variables 2 and 3 define the microstructure and texture, respectively.

Analysis options to invoke: Large Strain, Updated Lagrange. 
% plan: The analysis options are most conveniently defined through the procedure file.
