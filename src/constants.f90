...
module constants
  ...
  real(pREAL), parameter :: &
    ...
    K_B = 1.380649e-23_pREAL, &                                                                     !< Boltzmann constant in J/K (https://doi.org/10.1103/RevModPhys.97.025002)
    N_A = 6.02214076e23_pREAL, &                                                                    !< Avogadro constant in 1/mol (https://doi.org/10.1103/RevModPhys.97.025002)
    R = K_B * N_A                                                                                   !< gas constant in J/(K mol)
