...
class TestMechanics:
    ...
    def test_vectorize_1_arg(self,np_rng,assert_allclose,vectorized,single):
    ...
    def test_vectorize_rotation(self,np_rng,assert_allclose):
    ...
    def test_vectorize_2_arg(self,np_rng,assert_allclose,vectorized,single):
    ...
    def test_vectorize_strain(self,np_rng,assert_allclose,vectorized,single):
        F     = np_rng.random((self.n,3,3))
    ...
    def test_stress_measures(self,np_rng,assert_allclose,function):
        """Ensure that all stress measures are equivalent for no deformation."""
        P = np_rng.random((self.n,3,3))
        assert_allclose(function(P,np.broadcast_to(np.eye(3),(self.n,3,3))),tensor.symmetric(P))

    def test_polar_decomposition_identity(self,np_rng,assert_allclose):
        """F = RU = VR."""
    ...
    def test_polar_decomposition(self,np_rng,assert_allclose,side):
        F     = np_rng.random((self.n,3,3))
    ...
    def test_strain_no_rotation(self,np_rng,assert_allclose,m_factor):
    ...
    def test_strain_rotation_equivalence(self,np_rng,assert_allclose,m_factor):
    ...
    def test_strain_rotation(self,np_rng,assert_allclose,m_factor,t):
    ...
    def test_rotation_determinant(self,np_rng,assert_allclose):
        """
    ...
    def test_deviatoric_Mises(self,np_rng,assert_allclose):
    ...
    def test_spherical_Mises(self,np_rng,assert_allclose,Mises_equivalent):
    ...
    def test_Mises(self,np_rng,assert_allclose):
    ...
    def test_spherical_no_shear(self,np_rng,assert_allclose):
