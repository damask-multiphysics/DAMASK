...
from ._typehints import FileHandleBinary, FloatSequence, StrSequence
...
class ConfigMaterial(YAML):
    ...
    def load_DREAM3D(fname: Union[str, Path],
        ...
        the DREAM3D file. This data is typically available when the microstructure
    ...
    def material_add(self,*,
        ...
        material:
          - constituents:
              - phase: Ferrite
                O: [0.6969, -0.1476, 0.2216, 0.66587]
                v: 1.0
            homogenization: SX
          - constituents:
              - phase: Martensite
                O: [0.2475, 0.0480, 0.9042, 0.3445]
                v: 1.0
            homogenization: SX
          - constituents:
              - phase: Ferrite
                O: [0.3139, 0.0907, -0.9448, 0.0210]
                v: 1.0
            homogenization: SX
        ...
        - constituents:
          - phase: Austenite
            v: 0.2
            O: [0.6969132891758002, -0.1476362765528585, 0.2216389050803762, 0.6658765598596691]
          - phase: Austenite
            v: 0.2
            O: [0.2475819773443465, 0.04809123010192928, 0.904259742116673, 0.34453550886466616]
          - phase: Austenite
            v: 0.2
            O: [0.3139692459865422, 0.09073480014671378, -0.9448532258621292, 0.021044956519467854]
          - phase: Ferrite
            v: 0.4
            O: [0.5537514257966947, -0.5026015104192761, 0.08897239297106825, 0.6579019633968209]
          homogenization: Taylor
        - constituents:
          - phase: Austenite
            v: 0.2
            O: [0.7172149343740911, -0.2770767162538715, 0.23659955504154967, -0.5940133683469425]
          - phase: Austenite
            v: 0.2
            O: [0.23921706645562466, 0.4937873807231346, -0.7776953986607941, 0.3068209325596603]
          - phase: Austenite
            v: 0.2
            O: [0.5622506961348308, 0.1752237011092118, -0.20329889653102953, -0.7822022551327461]
          - phase: Ferrite
            v: 0.4
            O: [0.13401900510818332, 0.8158357734898908, 0.021103740056067754, -0.562143690811887]
          homogenization: Taylor
        - constituents:
          - phase: Austenite
            v: 0.2
            O: [0.2672704659393575, 0.05557068130575109, -0.9595927631051505, -0.06826511855988983]
          - phase: Austenite
            v: 0.2
            O: [0.03178328169337322, 0.17934957260340084, -0.9047596784343693, -0.3850110103505013]
          - phase: Austenite
            v: 0.2
            O: [0.15753208810134994, 0.8108466056675085, 0.23981944843132236, -0.5100961237355217]
          - phase: Ferrite
            v: 0.4
            O: [0.4375496678804596, 0.6715876645810882, -0.36579794745808797, -0.4729821968696807]
          homogenization: Taylor
        - constituents:
          - phase: Austenite
            v: 0.2
            O: [0.08413071788300876, -0.7269920099235408, -0.39402223546354526, 0.5560135949562117]
          - phase: Austenite
            v: 0.2
            O: [0.19052601418388146, -0.2823191743587663, 0.9379945593125503, -0.06451300960769536]
          - phase: Austenite
            v: 0.2
            O: [0.12744644628895352, -0.6497100759029504, -0.467971860053968, -0.585351653962068]
          - phase: Ferrite
            v: 0.4
            O: [0.004912243663046866, 0.2176912963361018, 0.8920287425514002, 0.39606955427534446]
          homogenization: Taylor
        - constituents:
          - phase: Austenite
            v: 0.2
            O: [0.2587691618565375, -0.007252965517899915, 0.9089711360007422, -0.3267374929217359]
          - phase: Austenite
            v: 0.2
            O: [0.3404808272024398, 0.24735626077376177, 0.15880689305403636, 0.893122644031652]
          - phase: Austenite
            v: 0.2
            O: [0.36201144598180474, -0.015090044162058306, -0.6177365901913936, 0.6979409062979903]
          - phase: Ferrite
            v: 0.4
            O: [0.019435942294642194, 0.6665834163546952, 0.6935127980340928, 0.272633072371908]
          homogenization: Taylor
        """
        dim = {'O':(4,),'V_e':(3,3,)}
